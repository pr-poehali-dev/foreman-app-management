...
export default function Login({ onLogin }: Props) {
  ...
  return (
    <div
      ...
      <div className="w-full max-w-sm relative animate-fade-in pb-safe">
        {/* Logo */}
        <div className="text-center mb-8 sm:mb-10">
          <div
            ...
            <Icon name="HardHat" size={28} style={{ color: "#000" }} />
          </div>
          ...
          <p className="text-sm mt-1" style={{ color: "var(--text-muted)" }}>
            ИП МАСАЛОВ — управление строительством
          </p>
        </div>

        {/* Form */}
        <form onSubmit={submit} className="app-card p-5 sm:p-6 flex flex-col gap-4">
          {/* Login field */}
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 pr-4 py-3.5 rounded-xl text-base outline-none transition-all"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 pr-11 py-3.5 rounded-xl text-base outline-none transition-all"
                style={{ background: "var(--surface-3)", border: "1px solid var(--surface-4)", color: "var(--text-primary)" }}
                onFocus={e => (e.target.style.borderColor = "var(--orange)")}
                onBlur={e => (e.target.style.borderColor = "var(--surface-4)")}
              />
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-orange w-full py-3.5 text-sm font-bold flex items-center justify-center gap-2 mt-1 min-h-[44px]"
        ...
        <p className="text-center text-xs mt-4 pb-safe" style={{ color: "var(--text-muted)" }}>
